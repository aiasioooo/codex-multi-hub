    ...
    instances: {
      zxc: {
        ...
        threads: [
          ...
          { id: "middle", name: "Hub Intermediator — Momo", preview: "", status: { type: "idle" }, updatedAt: 1, runtime: { model: "gpt-test", effort: "low" } },
        ],
      },
    },
  ...
  const result = buildObserverState({
    instances: {
      zxc: {
        ...
        port: 1234,
        updatedAt: now,
        threads: [{ id: "host-z", name: "Nacchan Host — Momo", status: { type: "idle" }, updatedAt: Date.now() }],
      },
    },
    intermediators: [],
    messages: [
